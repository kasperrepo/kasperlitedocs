...
* Giao diện chức năng thêm đơn giá:
     ...
     * (13): Nhập vé cầu đường cho tuyến (nếu có)
     ...
     * (18): Nhập số tiền tính phụ thu theo loại đơn hàng vừa chọn (nếu có chọn ở mục (17))

     **ĐƠN GIÁ BÁN**

     * (19): Nhập số tiền giảm giá cho khách hàng (nếu có)
     * (20): Lương (hệ thống sẽ tự tính theo mức lương cơ sở đã định nghĩa)
     ...
     **Kết quả:**
     ...
     <a href='assets/billing/ResultSaveUnitPriceFclOfRouteBasic.png'>
          ![](assets/billing/ResultSaveUnitPriceFclOfRouteBasic.png)
     </a>
...
* Giao diện chức năng sửa đơn giá:
     ...
     **THÔNG TIN ĐƠN GIÁ THEO TUYẾN CƠ SỞ**
     ...
     <a href='assets/billing/EditUnitPriceFclDetails_2.png'>
          ![](assets/billing/EditUnitPriceFclDetails_2.png)
     </a>
